			...
			<div class="auth-card">
				...
				<form action="${pageContext.request.contextPath}/member/register" method="post">
					...
					<div>
						...
						<input type="text" class="custom-input" id="username" name="username" placeholder="아이디를 입력하세요"
							required>
					</div>
					...
					<div>
						...
						<input type="text" class="custom-input" id="phone" name="phone" placeholder="010-0000-0000">
					</div>

					<div>
						<label for="email" class="custom-label">Email</label>
						<input type="email" class="custom-input" id="email" name="email" placeholder="example@mail.com">
					</div>
