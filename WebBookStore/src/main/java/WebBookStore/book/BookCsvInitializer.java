...
public class BookCsvInitializer {
        ...
        try {
            ...
            try (CSVReader reader = new CSVReader(
                ...
                while ((arr = reader.readNext()) != null) {
                    ...
                    insertBook(isbn, bookname, author, publisher, image, price);
                }
            }
    ...
    private void insertBook(int isbn, String bookname, String author,
                            String publisher, String image, String price) throws Exception {

        String sql = "INSERT INTO book (isbn, bookname, author, publisher, image, price) "
                   + "VALUES (?, ?, ?, ?, ?, ?)";
